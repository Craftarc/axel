...
TEST_F(OauthManager_test,
       DISABLED_receive_auth__ok_if_state_hash_matches) { //TODO: Mock oauth_manager.receive_auth() as well because it accesses DynamoDB
...
TEST_F(OauthManager_test, DISABLED_receive_auth__fail_if_state_hash_does_not_match) {
