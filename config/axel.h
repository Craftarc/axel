...
namespace config {
    ...
    namespace axel {
        ...
        namespace database {
            ...
            const std::unordered_map<Aws::String,
                                     Aws::DynamoDB::Model::ValueType>
            auth_attributes = {
                { "session_id", Aws::DynamoDB::Model::ValueType::STRING },
                { "state_hash", Aws::DynamoDB::Model::ValueType::STRING },
                { "code_verifier", Aws::DynamoDB::Model::ValueType::STRING },
                { "time_to_live", Aws::DynamoDB::Model::ValueType::NUMBER }
            };
            ...
            app_attributes = {
                { "session_id", Aws::DynamoDB::Model::ValueType::STRING },
                { "access_token", Aws::DynamoDB::Model::ValueType::STRING },
                { "time_to_live", Aws::DynamoDB::Model::ValueType::NUMBER }
            };
        }  // namespace database
    }      // namespace axel
